        ...
        {/* <div className="BoxCenter"> */}
          <div className="card slide-card">
            <div className="card-body">
              ...
              <p className="card-text">
                We understand that electrical emergencies can happen at any
                time. That's why we offer 24/7 emergency electrical services to
                get your systems up and running promptly.
              </p>
            </div>
          </div>
          ...
          <div className="card slide-card">
            <div className="card-body">
              ...
              <p className="card-text">
                Keep your systems running smoothly with our maintenance
                services, and enhance their performance with our upgrade
                solutions.{" "}
              </p>
            </div>
          </div>
